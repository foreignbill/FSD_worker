...
class Lock(object):
    ...
    def __init__(self, redis_client, name, expire=None, id=None, auto_renewal=False, strict=True, signal_expire=1000):
        ...
        if strict and not isinstance(redis_client, StrictRedis):
            raise ValueError(
                "redis_client must be instance of StrictRedis. Use strict=False if you know what you're doing.")
    ...
    def extend(self, expire=None):
        ...
        if expire:
            ...
            raise TypeError(
                "To extend a lock 'expire' must be provided as an argument to extend() method or at initialization time.")
    ...
    def _start_lock_renewer(self):
        ...
        logger_for_refresh_start.debug(
            "Starting renewal thread for Lock(%r). Refresh interval: %s seconds.", self._name,
